  ...
  return (
    <section className="py-24 bg-secondary relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <h2 className="font-display font-bold text-3xl md:text-5xl text-secondary-foreground mb-6">
            Ready to get started?
          </h2>
          <p className="text-secondary-foreground/60 text-lg mb-10">
            Join hundreds of customers across Guyana who trust MaceyRunners for fast, reliable delivery.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/signup">
              <Button size="lg" className="bg-primary hover:bg-primary/90 text-primary-foreground rounded-full px-8 text-base h-12 w-full sm:w-auto">
