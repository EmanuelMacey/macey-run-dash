...
// Scheduled long-term maintenance closure — effective immediately, until further notice
const MAINTENANCE_START = new Date("2026-06-04T00:00:00-04:00"); // Guyana time
...
export const MAINTENANCE_CLOSURE_MESSAGE =
  "MaceyRunners is temporarily closed for system upgrades and improvements. We sincerely apologize for any inconvenience and will resume operations soon.";
