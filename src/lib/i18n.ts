...
"pricing.delivery.price": "From $1,000",
      "pricing.delivery.desc": "Food, groceries & packages — $1,000 flat in Georgetown, distance-based outside",
      "pricing.delivery.note": "$1,000 in central Georgetown • $500 base + $250/km outside",
