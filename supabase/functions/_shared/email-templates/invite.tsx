...
export const InviteEmail = ({ siteName, siteUrl, confirmationUrl }: InviteEmailProps) => (
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>You've been invited to join MaceyRunners! 🏃</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={content}>
          ...
          <Text style={text}>
            ...
            — Guyana's fastest delivery and errand service. Accept below to create your account.
          </Text>
          <Section style={buttonContainer}>
            <Button style={button} href={confirmationUrl}>Accept Invitation</Button>
          </Section>
          <Text style={subtext}>If you weren't expecting this, you can safely ignore this email.</Text>
        </Section>
