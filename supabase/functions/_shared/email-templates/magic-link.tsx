...
export const MagicLinkEmail = ({ siteName, confirmationUrl }: MagicLinkEmailProps) => (
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Your MaceyRunners login link</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={content}>
          ...
          <Text style={text}>Tap the button below to log in to MaceyRunners. This link will expire shortly!</Text>
          <Section style={buttonContainer}>
            <Button style={button} href={confirmationUrl}>Log In to MaceyRunners</Button>
          </Section>
          <Text style={subtext}>If you didn't request this link, you can safely ignore this email.</Text>
        </Section>
