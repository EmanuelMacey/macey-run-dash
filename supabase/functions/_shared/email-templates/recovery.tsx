...
export const RecoveryEmail = ({ siteName, confirmationUrl }: RecoveryEmailProps) => (
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Reset your MaceyRunners password</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={content}>
          ...
          <Text style={text}>We received a request to reset your MaceyRunners password. Click below to choose a new one.</Text>
          <Section style={buttonContainer}>
            <Button style={button} href={confirmationUrl}>Reset Password</Button>
          </Section>
          <Text style={subtext}>If you didn't request this, no worries — your password stays the same.</Text>
        </Section>
