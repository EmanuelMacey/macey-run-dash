...
const EMAIL_SUBJECTS: Record<string, string> = {
  signup: 'Welcome to MaceyRunners — Verify Your Email 🏃',
  invite: "You're Invited to MaceyRunners! 🎉",
  magiclink: 'Your MaceyRunners Login Link 🔗',
  recovery: 'Reset Your MaceyRunners Password 🔑',
  email_change: 'Confirm Your Email Change — MaceyRunners',
  reauthentication: 'Your MaceyRunners Verification Code 🔐',
}
...
// Configuration
const SITE_NAME = "MaceyRunners"
const SENDER_DOMAIN = "notify.www.maceyrunners.com"
const ROOT_DOMAIN = "www.maceyrunners.com"
const FROM_DOMAIN = "www.maceyrunners.com" // Domain shown in From address (may be root or sender subdomain)
...
const SAMPLE_PROJECT_URL = "https://macey-run-dash.lovable.app"
